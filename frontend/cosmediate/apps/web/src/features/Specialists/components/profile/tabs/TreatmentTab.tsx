...
import type { Specialist, Treatment } from "@cosmediate/type-utils";
...
const TreatmentsTab = ({ specialist }: { specialist: Specialist }) => {
  ...
  const config = useMemo(() => {
    ...
    const scope = `detail:specialists:${specialist.id}:treatments`;
  ...
  }, [treatmentCategories, treatmentBrands, priceData, specialist.id, browse]);

...
const ContactTab = ({ specialist }: { specialist: Specialist }) => {
  const profile = useTranslations("profile");
  const workingHours = useMemo(() => specialist.workingHours, [specialist]);
      ...
      >
        ...
        >
          <ContactInfoContainer
            ...
            value={specialist?.completeAddress || profile.sections.notAvailable}
          />
          <ContactInfoContainer
            title={profile.sections.website}
            value={specialist?.website || profile.sections.notAvailable}
          />
          <ContactInfoContainer
            title={profile.sections.instagram}
            value={specialist?.instagramId || profile.sections.notAvailable}
          />
        </div>

...
import { resendSignupCodeApi } from "@cosmediate/api";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const apiRes = await resendSignupCodeApi(
      { email },
    ...
    console.error("[auth:/api/confirm-signup/resend] Unexpected error", error);

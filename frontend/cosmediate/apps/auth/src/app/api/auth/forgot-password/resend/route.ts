...
import { resendForgotPasswordCodeApi } from "@cosmediate/api";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const apiRes = await resendForgotPasswordCodeApi(
      { email },
    ...
    console.error("[auth:/api/forgot-password/resend] Unexpected error", error);

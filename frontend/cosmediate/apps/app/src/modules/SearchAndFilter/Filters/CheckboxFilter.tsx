...
import { Label, Checkbox, ButtonLoader } from "@cosmediate/ui";
          ...
          {config.options.map((option) => (
            ...
            >
              <Checkbox
                ...
                className="data-[state=checked]:bg-primary-accent data-[state=checked]:border-primary-accent-dark data-[state=unchecked]:!bg-white"
              />
              <Label

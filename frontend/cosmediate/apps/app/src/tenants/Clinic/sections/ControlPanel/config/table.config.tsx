...
export const ManagersDataColumns = (
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <CrudActionButtons
          ...
          viewHref={`/control-panel/managers/${row.original.id}`}
          editHref={`/control-panel/managers/update/${row.original.id}`}
...
export const ManagerAuditLogsPickerColumns = (
  viewMode: string,
  perms: string[] = [],

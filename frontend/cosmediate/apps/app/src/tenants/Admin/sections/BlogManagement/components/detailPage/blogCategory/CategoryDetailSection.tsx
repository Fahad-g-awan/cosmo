    ...
    <div className="w-full flex flex-col itemc-center justify-start gap-5">
      ...
      <div className="w-full grid grid-cols-2 items-start justify-center gap-6">
        <div className="w-full flex flex-col items-start justify-start gap-2">
          ...
          <Badge
            variant={blogCategory.published ? "default" : "secondary"}
            className={
          ...
          >
            ...
            {blogCategory.published ? "Published" : "Unpublished"}
          </Badge>
        </div>

        <div className="w-full flex flex-col items-start justify-start gap-2">
          <p className="text-sm text-muted-foreground mb-2">Blog Count</p>
          <div className="flex items-center gap-2">
            <Hash className="h-4 w-4 text-blue-500" />
            <span className="text-lg font-semibold">
              {blogCategory.blogCount ?? 0}
            </span>

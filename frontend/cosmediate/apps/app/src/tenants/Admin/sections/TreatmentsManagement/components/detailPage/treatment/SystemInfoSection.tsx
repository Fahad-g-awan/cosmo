...
export const SystemInfoSection = ({ treatment }: { treatment: Treatment }) => {
  return (
      ...
      <div className="w-full flex flex-col items-center justify-start">
        <div className="w-full grid grid-cols-2 max-sm:grid-cols-1 gap-4">
          <div className="w-full flex flex-col items-start justify-start gap-2 p-3 bg-primary-accent/5 rounded-lg">
            <p className="text-xs text-muted-foreground mb-1">treatment ID</p>
          ...
          <div className="w-full flex flex-col items-start justify-start gap-2 p-3 bg-primary-accent/5 rounded-lg">
            ...
            <p className="text-sm font-medium">{treatment.tags?.length || 0}</p>
          </div>
          <div className="w-full flex flex-col items-start justify-start gap-2 p-3 bg-primary-accent/5 rounded-lg">
            <p className="text-xs text-muted-foreground mb-1">Clinic Count</p>
            <p className="text-sm font-medium">{treatment.clinicCount || 0}</p>
          </div>
          <div className="w-full flex flex-col items-start justify-start gap-2 p-3 bg-primary-accent/5 rounded-lg">

    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "bg-transparent border-0! outline-none shadow-none rounded-b-none rounded-t-xl",
      ...
      >
        <div
          className={cn(
            "bg-white/80 mx-auto mt-4 hidden h-1.5 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
          )}
        />
        <div className="bg-white mt-2 rounded-t-xl p-2 py-3">{children}</div>
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
}
